...
def run():
    ...
    <div class="title-container">
        <div class="main-title">AI RESUME INTELLIGENCE</div>
        <div class="subtitle">Smart Resume Analysis • Predictive Insights • Career Optimization</div>
        <div class="branding">A Rohith Reddy Creation 🚀</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    link = '<b>Built with 🚀 by <span style="color:#0ea5e9;">A Rohith Reddy</span></b>'
    st.sidebar.markdown('''
        <!-- site visitors -->
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'rohit' and ad_password == 'Rohith@91':
                ...
                st.success("Welcome A Rohith Reddy! Total %d " % values + " Users Have Used Your Tool 🚀")
